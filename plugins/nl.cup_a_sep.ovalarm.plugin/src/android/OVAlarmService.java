...
public class OVAlarmService extends BackgroundService {
    
    // Needed for system log
    private final static String TAG = OVAlarmService.class.getSimpleName();
    
    // Variables with obvious names
    private long mNextAlarmTimestamp = Long.MAX_VALUE;
    private String mSBNTitle = "OV Alarm";
    private String mSBNBody = "OV alarm gaat af!";
    private static final String PREFS_NAME = "OVAlarmServiceSettings";
    ...
    protected JSONObject doWork() {
        ...
        try {
            ...
            Log.d(TAG, "JSONException in OVAlarmService");
        }
